...
**Provenance:** Manual backfill approved for publication. The eight retained entries and their summaries come from the original production candidate; categories and keywords are curated from that same title-and-summary evidence. No independently verifiable automated site-check totals were retained for this candidate.

---

## 📋 Executive Summary

Across 8 items this week, the evidence concentrated on physical-risk monitoring, water-cycle and soil-risk modeling, adaptation and resilience, scenario analysis and pricing, and climate disclosure and mortality tables.

New monitored-site developments include the IWMI-IPCC co-sponsored expert meeting on addressing water risks and building resilience to climate change; Europe's devastating heatwaves and wildfires in 4 charts; and another triple COP year and what that means for business leaders.

Wider-intelligence items include Risk Management and Climate Risk: A Collection of Essays — SOA (web); and Climate-Related Scenarios Applied to Insurers and Other Financial Institutions — IAA (web).
...
- Total published items: **8** (6 Pillar A, 2 Pillar B)
...
- **What is the 'Year of Water' - and how can it address the water crisis?**
  - **Categories:** Adaptation & Resilience, Physical Risk
  - Addresses global water crisis and climate adaptation needs, relevant to water-risk actuarial modeling.
