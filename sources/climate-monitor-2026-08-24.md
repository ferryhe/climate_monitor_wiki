...
**Generated:** 2026-08-24 08:17 UTC
...
- Pillar B internet search window: **last 3 months** (2026-05-26 → 2026-08-24)
...
- **UNEP FI at the World Circular Economy Forum**
  - UNEP FI (the insurance-industry sustainability body) is participating in the World Circular Economy Forum, highlighting circular-economy approaches relevant to insurers' climate-transition and sustainability risk assessment.
  🔗 https://www.unepfi.org/events/unep-fi-at-the-world-circular-economy-forum


**UNDP**
- **Restoring land, reducing disasters**
  - UNDP shows how land restoration reduces disaster risk - a concrete climate-adaptation and resilience measure actuaries should weigh in catastrophe and sovereign risk modelling.
  🔗 https://www.undp.org/stories/restoring-land-reducing-disasters


**WEF**
- **How AI and power systems are rewriting each other's rules**
  - WEF examines how AI and power systems co-evolve amid the energy transition; relevant to actuaries pricing transition risk and grid/climate resilience in infrastructure portfolios.
  🔗 https://www.weforum.org/stories/energy-transition/how-ai-and-power-systems-are-rewriting-each-others-rules

- **Switzerland's solar railway is on the right track**
