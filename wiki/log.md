...
## [2026-04-25] daily-update | Add 2026-04-24/25 reports + topic refresh
Source: GitHub sources/climate-monitor-2026-04-24.md and climate-monitor-2026-04-25.md
Actions:
  - GitHub wiki/: created climate-monitor-2026-04-24.md and climate-monitor-2026-04-25.md via sync_source_wiki.py
  - GitHub wiki/: refreshed index.md for the two new daily report rows and updated concept summaries/dates
  - GitHub wiki/: updated actuaries-climate-index.md, parametric-insurance.md, nat-cat-protection-gap.md, isbb-ifrs-s2.md, climate-finance.md
  - GitHub sources/: normalized 2026-04-25 into the standard daily-monitor source format so wiki sync extracts a clean summary
  - GitHub README.md and docs/source-update-sop.md: rolled forward latest-date examples and coverage text
  - Validation: pytest passed; sync_source_wiki.py regenerated the expected daily pages
---
...
Pages created: 13 wiki pages
Pages affected:
  - sources/climate-monitor-2026-04-20.md (new)
  - sources/climate-monitor-2026-04-17.md (new)
  - sources/climate-monitor-2026-04-16.md (new)
  - sources/climate-monitor-2026-04-14.md (new)
  - sources/climate-monitor-2026-04-09.md (new)
  - sources/climate-monitor-2026-04-08.md (new)
  - sources/climate-monitor-2026-04-07.md (new)
  - sources/climate-monitor-2026-04-06.md (new)
  - sources/climate-monitor-2026-04-05.md (new)
  - sources/climate-monitor-2026-04-04.md (new)
  - sources/climate-monitor-2026-04-03.md (new)
  - sources/climate-monitor-2026-04-02.md (new)
  - wiki/secondary-perils.md (new)
  - wiki/isbb-ifrs-s2.md (new)
  - wiki/actuaries-climate-index.md (new)
  - wiki/parametric-insurance.md (new)
  - wiki/nat-cat-protection-gap.md (new)
  - wiki/iais-climate-risk.md (new)
  - wiki/fsb-climate-risk.md (new)
  - wiki/swiss-re-sigma.md (new)
  - wiki/cas-soa-climate-research.md (new)
  - wiki/talents-gap.md (new)
  - wiki/wri-colombia.md (new)
